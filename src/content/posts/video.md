...
只要把 YouTube 或其他平台提供的嵌入代码复制出来，再粘贴进 Markdown 文件里就可以了。
...
<iframe width="100%" height="468" src="//player.bilibili.com/player.html?bvid=BV1fK4y1s7Qf&p=1" title="Bilibili 视频播放器" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
